...
export class MultiselectAutocompleteExample implements OnInit {
  ...
  storedUserControl = new FormControl();
  @ViewChild("autocompleteInput") autoInput: ElementRef;
  ...
  onFocus() {
    // this.storedUserControl.setValue(this.userControl.value)
  ...
  onBlur() {
    this.autoInput.nativeElement.value = this.displayFn(this.selectedUsers);
    console.log("onblur");
    console.log(this.selectedUsers);
    // this.userControl.setValue({
    //   ...this.storedUserControl.value,
